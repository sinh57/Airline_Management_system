...
if(isset($_GET['id'])){
    ...
    // Check if flight exists and get business class price
    $stmt = mysqli_prepare($con, "SELECT FLIGHT_CODE, PRICE_BUSINESS FROM flight WHERE FLIGHT_CODE = ?");
    ...
    $_SESSION['ticket_type'] = 'BUSINESS CLASS';
