...
if(isset($_GET['id'])){
    ...
    // Check if flight exists and get student price
    $stmt = mysqli_prepare($con, "SELECT FLIGHT_CODE, PRICE_STUDENTS FROM flight WHERE FLIGHT_CODE = ?");
